	...
	return (
		<MuiPickersUtilsProvider utils={MomentUtils}>
			<Modal>
				...
				<TextField value={name} label="name" type="text" onChange={(e: React.ChangeEvent<HTMLInputElement>) => setName(e.target.value)} />
				<DatePicker className="remove-bottom-border" value={voteStart} onChange={setVoteStart} disablePast={true} />
				<DatePicker className="remove-bottom-border" value={seasonStart} onChange={setSeasonStart} disablePast={true} />
