...
const Screen: FunctionComponent = () => {
	...
	const handleJoin = async () => {
		...
		if (seasons[seasonID])  return setError('you are already enrolled in this season')
	...
	return (
		<Modal>
			...
			<TextField value={seasonID} label="seasonID" type="text" onChange={(e: React.ChangeEvent<HTMLInputElement>) => setSeasonID(e.target.value)} />
